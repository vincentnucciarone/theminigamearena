  ...
  app.innerHTML = panel(`
    <div class="game-wrap">
      <div class="game-header">
        <div><div class="kicker">${esc(sub)}</div><div class="game-title">${esc(title)}</div></div>
        <div class="badge" id="submitStatus">PLAYING</div>
      </div>
      <div class="game-stage" id="stage">${body}</div>
      <div class="row spread"><div class="subtle">RESULTS SUBMIT AUTOMATICALLY</div><div id="submissionCount" class="subtle"></div></div>
    </div>
  `, state.lobby ? `LOBBY ${state.lobby.code}` : 'GAME');
}
